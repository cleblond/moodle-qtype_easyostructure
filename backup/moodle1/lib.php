...
/**
 * easyostructure question type conversion handler
 */
class moodle1_qtype_easyostructure_handler extends moodle1_qtype_handler {
    ...
    /**
     * Appends the easyostructure specific information to the question
     */
